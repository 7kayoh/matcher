...
function M.new(candidates: {string|{string}}, search_case_insensitive: boolean?, search_fuzzy: boolean?)
	local m = {
...
function M:explain(search: string, text: string): {Explanation}
...
function M:match(search: string): {string}
...
function M:_set_candidates(candidates: {string|{string}})
...
function M:_matchers_for_search(search_string: string): {(string) -> (number?)}
